...
# Display the first six rows of the "cleaned_case_data" dataset
...
# Create a bar chart to visualize the distribution of COVID-19 cases by gender based on the analyzed_case_data dataset
# Reference: https://tellingstorieswithdata.com/02-drinking_from_a_fire_hose.html#explore 
analyzed_case_data |> 
  ggplot(aes(x = gender)) +
  # Change bar color to green
  geom_bar(fill = "#D4E7C5") +
  geom_text(
    # Use the 'count' statistic to calculate counts for each category
    stat = 'count',
    # Use percentage labels based on count and set y position of text labels
    aes(label = scales::percent(..count.. / sum(..count..)),
        y = ..count..),
    # Adjust vertical position of text labels
    vjust = -0.5,
    # Stack text labels on top of bars
    position = position_stack(vjust = 0.5)
  ) +
  # Apply a minimal theme to the chart
  theme_minimal() +
  # Label x-axis as "Gender" and y-axis as "Number of COVID-19 cases"
  labs(x = "Gender",
...
# Create a bar chart to visualize the distribution of COVID-19 cases by age group based on the analyzed_case_data dataset
# Reference: https://tellingstorieswithdata.com/02-drinking_from_a_fire_hose.html#explore 
analyzed_case_data |> 
  ...
  geom_text(
    ...
    # Stack text labels on top of bars
    position = position_stack(vjust = 0.5),
    # Change text size to 3
    size = 3
  ) +
  # Apply a minimal theme to the chart
  theme_minimal() +
  # Label x-axis as "Age group" and y-axis as "Number of COVID-19 cases"
  labs(x = "Age group",
       y = "Number of COVID-19 cases")
```
...
analyzed_case_data |> 
  # Create a ggplot object with age_group on the x-axis and gender as fill color
  ggplot(aes(x = age_group, fill = gender)) +
  # Add a grouped bar layer to create the grouped bar chart
  geom_bar(position = "dodge") +
  # Scale the x-axis labels to display "Age group"
  scale_x_discrete("Age group") +
  # Scale the fill color to display "Gender" and specify the break points: "Male", "Female", "Other"
  scale_fill_discrete(name = "Gender",
                      breaks = c("Male", "Female", "Other")) +
  # Apply a minimal theme to the chart
  theme_minimal() +
  # Label y-axis as "Number of COVID-19 cases"
